...
vector<int> QueryProcessor::processSelectQuery(FILE *fp, int col1, string value){
...
vector<int> QueryProcessor::processJoinQuery(FILE *fp1, FILE *fp2, int col1, int col2){
...
int main(){
    ...
    for(int choice=1;choice<=3;++choice){
        for(int i=2;i<=20;++i){
            QueryProcessor qp(i, choice);
            vector<int>v;
            // v = qp.processSelectQuery(fp1, 2, "8");
